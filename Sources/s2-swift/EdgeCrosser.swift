...
struct EdgeCrosser {
  ...
  var aTangent: S2Point // Outward-facing tangent at A.
  var bTangent: S2Point // Outward-facing tangent at B.
...
// needed.
let intersectionError = S1Angle(8 * Cell.dblEpsilon)
...
func crossingSign(a: S2Point, b: S2Point, c: S2Point, d: S2Point) -> Crossing {
...
func vertexCrossing(a: S2Point, b: S2Point, c: S2Point, d: S2Point) -> Bool {
...
func edgeOrVertexCrossing(a: S2Point, b: S2Point, c: S2Point, d: S2Point) -> Bool {
...
// very small angle.
func intersection(a0: S2Point, a1: S2Point, b0: S2Point, b1: S2Point) -> S2Point {
...
func robustNormalWithLength(x: R3Vector, y: R3Vector) -> (R3Vector, Double) {
...
func projection(x: R3Vector, aNorm: R3Vector, aNormLen: Double, a0: S2Point, a1: S2Point) -> (proj: Double, bound: Double) {
...
func compareEdges(a0: S2Point, a1: S2Point, b0: S2Point, b1: S2Point) -> Bool {
...
// Intersection.
func intersectionStable(a0: S2Point, a1: S2Point, b0: S2Point, b1: S2Point) -> S2Point? {
...
func intersectionStableSorted(a0: S2Point, a1: S2Point, b0: S2Point, b1: S2Point) -> S2Point? {
...
// to be negated).
func intersectionExact(a0: S2Point, a1: S2Point, b0: S2Point, b1: S2Point) -> S2Point {
